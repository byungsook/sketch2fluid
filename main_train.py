...
parser.add_argument('--ratio', type=float, default=1, help='dataset training samples ratio')
...
parser.add_argument('--use_aug', type=str2bool, default=True, help='if use sketch augmentation')
parser.add_argument('--run_all_views', type=str2bool, default=False, help='if use sphere mask')

parser.add_argument('--render_scale', type=int, default=1, help='rendering scale for visualization')
# parser.add_argument('--sigmas', type=float, default=0.6, help='if use sphere mask')
parser.add_argument('--milestones', type=int, default=500, help='milestones for increasing w_prev')
